...
abstract class CallRemoteDataSource {
  Future<CallConnectionModel> initiateCall({required int conversationId, required CallType callType});

  Future<CallConnectionModel> acceptCall({required String callId});

  Future<CallConnectionModel> joinCall({required String callId});
  ...
  Future<CallInfoModel?> getActiveCall({required int conversationId});
}
