...
class InitiateCallUseCase {
  ...
  Future<Either<Failure, CallConnection>> call({required int conversationId, required CallType callType}) {
    return repository.initiateCall(conversationId: conversationId, callType: callType);
  }
}
