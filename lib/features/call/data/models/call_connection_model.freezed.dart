...
mixin _$CallConnectionModel {
 ...
 CallInfoModel get callInfo; String get token;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CallConnectionModel&&(identical(other.callInfo, callInfo) || other.callInfo == callInfo)&&(identical(other.token, token) || other.token == token));
}
...
@override
String toString() {
  return 'CallConnectionModel(callInfo: $callInfo, token: $token)';
}
...
@useResult
$Res call({
 CallInfoModel callInfo, String token
});


$CallInfoModelCopyWith<$Res> get callInfo;
...
as CallInfoModel,token: null == token ? _self.token : token // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
/// Create a copy of CallConnectionModel
...
$CallInfoModelCopyWith<$Res> get callInfo {
  ...
  return $CallInfoModelCopyWith<$Res>(_self.callInfo, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( CallInfoModel callInfo,  String token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CallConnectionModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( CallInfoModel callInfo,  String token)  $default,) {final _that = this;
switch (_that) {
case _CallConnectionModel():
return $default(_that.callInfo,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( CallInfoModel callInfo,  String token)?  $default,) {final _that = this;
switch (_that) {
case _CallConnectionModel() when $default != null:
return $default(_that.callInfo,_that.token);case _:
  return null;
...
class _CallConnectionModel extends CallConnectionModel {
  const _CallConnectionModel({required this.callInfo, required this.token}): super._();
  factory _CallConnectionModel.fromJson(Map<String, dynamic> json) => _$CallConnectionModelFromJson(json);

@override final  CallInfoModel callInfo;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CallConnectionModel&&(identical(other.callInfo, callInfo) || other.callInfo == callInfo)&&(identical(other.token, token) || other.token == token));
}
...
@override $CallInfoModelCopyWith<$Res> get callInfo;
