...
@override
String toString() {
  return 'ContactModel(id: $id, userId: $userId, username: $username, email: $email, fullName: $fullName, avatarUrl: $avatarUrl, nickname: $nickname, isOnline: $isOnline, lastSeen: $lastSeen, createdAt: $createdAt)';
}
...
class _ContactModel extends ContactModel {
  const _ContactModel({required this.id, required this.userId, required this.username, required this.email, required this.fullName, this.avatarUrl, this.nickname, required this.isOnline, required this.lastSeen, required this.createdAt}): super._();
