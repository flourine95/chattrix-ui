...
abstract mixin class $UserModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({
    String id, String username, String email, String fullName, String? avatarUrl, @JsonKey(
        name: 'online') bool isOnline, String lastSeen
  });
...
class _UserModel extends UserModel {
  const _UserModel(
      {required this.id, required this.username, required this.email, required this.fullName, this.avatarUrl, @JsonKey(
          name: 'online') required this.isOnline, required this.lastSeen})
      : super._();
