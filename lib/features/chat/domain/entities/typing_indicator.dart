...
abstract class TypingIndicator with _$TypingIndicator {
  ...
  const factory TypingIndicator({required int conversationId, required List<TypingUser> typingUsers}) =
      _TypingIndicator;
}
...
abstract class TypingUser with _$TypingUser {
  ...
  const factory TypingUser({required int id, required String username, required String fullName}) = _TypingUser;
}
