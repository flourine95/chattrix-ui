...
mixin _$ConversationUpdate {
  ...
  $ConversationUpdateCopyWith<ConversationUpdate> get copyWith =>
      _$ConversationUpdateCopyWithImpl<ConversationUpdate>(
          this as ConversationUpdate, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ConversationUpdate &&
...
abstract mixin class $ConversationUpdateCopyWith<$Res> {
  factory $ConversationUpdateCopyWith(ConversationUpdate value,
      $Res Function(ConversationUpdate) _then) = _$ConversationUpdateCopyWithImpl;
...
extension ConversationUpdatePatterns on ConversationUpdate {
  ...
  TResult Function( _ConversationUpdate value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ConversationUpdate extends ConversationUpdate {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConversationUpdateCopyWith<_ConversationUpdate> get copyWith =>
      __$ConversationUpdateCopyWithImpl<_ConversationUpdate>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ConversationUpdate &&
            (identical(other.conversationId, conversationId) ||
                other.conversationId == conversationId) &&
            (identical(other.updatedAt, updatedAt) ||
                other.updatedAt == updatedAt) &&
...
/// @nodoc
abstract mixin class _$ConversationUpdateCopyWith<$Res>
    implements $ConversationUpdateCopyWith<$Res> {
  factory _$ConversationUpdateCopyWith(_ConversationUpdate value,
      $Res Function(_ConversationUpdate) _then) = __$ConversationUpdateCopyWithImpl;
...
mixin _$LastMessageInfo {
  ...
  $LastMessageInfoCopyWith<LastMessageInfo> get copyWith =>
      _$LastMessageInfoCopyWithImpl<LastMessageInfo>(
          this as LastMessageInfo, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LastMessageInfo &&
...
abstract mixin class $LastMessageInfoCopyWith<$Res> {
  factory $LastMessageInfoCopyWith(LastMessageInfo value,
      $Res Function(LastMessageInfo) _then) = _$LastMessageInfoCopyWithImpl;
...
extension LastMessageInfoPatterns on LastMessageInfo {
  ...
  TResult Function( _LastMessageInfo value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _LastMessageInfo extends LastMessageInfo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LastMessageInfoCopyWith<_LastMessageInfo> get copyWith =>
      __$LastMessageInfoCopyWithImpl<_LastMessageInfo>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _LastMessageInfo &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.content, content) || other.content == content) &&
            (identical(other.senderId, senderId) ||
                other.senderId == senderId) &&
...
/// @nodoc
abstract mixin class _$LastMessageInfoCopyWith<$Res>
    implements $LastMessageInfoCopyWith<$Res> {
  factory _$LastMessageInfoCopyWith(_LastMessageInfo value,
      $Res Function(_LastMessageInfo) _then) = __$LastMessageInfoCopyWithImpl;
