...
mixin _$UserStatusUpdate {
  ...
  $UserStatusUpdateCopyWith<UserStatusUpdate> get copyWith =>
      _$UserStatusUpdateCopyWithImpl<UserStatusUpdate>(
          this as UserStatusUpdate, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is UserStatusUpdate &&
...
abstract mixin class $UserStatusUpdateCopyWith<$Res> {
  factory $UserStatusUpdateCopyWith(UserStatusUpdate value,
      $Res Function(UserStatusUpdate) _then) = _$UserStatusUpdateCopyWithImpl;
...
extension UserStatusUpdatePatterns on UserStatusUpdate {
  ...
  TResult Function( _UserStatusUpdate value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _UserStatusUpdate extends UserStatusUpdate {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$UserStatusUpdateCopyWith<_UserStatusUpdate> get copyWith =>
      __$UserStatusUpdateCopyWithImpl<_UserStatusUpdate>(this, _$identity);


  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _UserStatusUpdate &&
            (identical(other.userId, userId) || other.userId == userId) &&
            (identical(other.username, username) ||
                other.username == username) &&
            (identical(other.displayName, displayName) ||
...
/// @nodoc
abstract mixin class _$UserStatusUpdateCopyWith<$Res>
    implements $UserStatusUpdateCopyWith<$Res> {
  factory _$UserStatusUpdateCopyWith(_UserStatusUpdate value,
      $Res Function(_UserStatusUpdate) _then) = __$UserStatusUpdateCopyWithImpl;
