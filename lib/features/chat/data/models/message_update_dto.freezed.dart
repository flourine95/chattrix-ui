...
mixin _$MessageUpdateDto {
 ...
 int get messageId; int get conversationId; String get content; bool get edited; String get updatedAt;
...
@useResult
$Res call({
 int messageId, int conversationId, String content, bool edited, String updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int messageId,  int conversationId,  String content,  bool edited,  String updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MessageUpdateDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int messageId,  int conversationId,  String content,  bool edited,  String updatedAt)  $default,) {final _that = this;
switch (_that) {
case _MessageUpdateDto():
return $default(_that.messageId,_that.conversationId,_that.content,_that.edited,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int messageId,  int conversationId,  String content,  bool edited,  String updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _MessageUpdateDto() when $default != null:
return $default(_that.messageId,_that.conversationId,_that.content,_that.edited,_that.updatedAt);case _:
  return null;
