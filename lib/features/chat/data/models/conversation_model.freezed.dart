...
mixin _$ConversationModel {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ConversationModel &&
  ...
  @override
  String toString() {
    return 'ConversationModel(id: $id, name: $name, type: $type, createdAt: $createdAt, updatedAt: $updatedAt, participants: $participants, lastMessage: $lastMessage)';
  }
...
abstract mixin class $ConversationModelCopyWith<$Res> {
  factory $ConversationModelCopyWith(ConversationModel value,
      $Res Function(ConversationModel) _then) = _$ConversationModelCopyWithImpl;

  @useResult
  $Res call({
    int id, String? name, String type, String createdAt, String updatedAt, List<
        ParticipantModel> participants, MessageModel? lastMessage
  });
...
class _$ConversationModelCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? name = freezed, Object? type = null, Object? createdAt = null, Object? updatedAt = null, Object? participants = null, Object? lastMessage = freezed,}) {
...
extension ConversationModelPatterns on ConversationModel {
  ...
  TResult Function( _ConversationModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
  ...
  @optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, String? name, String type, String createdAt, String updatedAt, List<ParticipantModel> participants, MessageModel? lastMessage)? $default,{required TResult orElse(),}) {final _that = this;
  switch (_that) {
  case _ConversationModel() when $default != null:
  ...
  @optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, String? name, String type, String createdAt, String updatedAt, List<ParticipantModel> participants, MessageModel? lastMessage) $default,) {final _that = this;
  switch (_that) {
  case _ConversationModel():
  return $default(_that.id,_that.name,_that.type,_that.createdAt,_that.updatedAt,_that.participants,_that.lastMessage);case _:
  throw StateError('Unexpected subclass');
  ...
  @optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, String? name, String type, String createdAt, String updatedAt, List<ParticipantModel> participants, MessageModel? lastMessage)? $default,) {final _that = this;
  switch (_that) {
  case _ConversationModel() when $default != null:
  return $default(_that.id,_that.name,_that.type,_that.createdAt,_that.updatedAt,_that.participants,_that.lastMessage);case _:
  return null;
...
class _ConversationModel extends ConversationModel {
  const _ConversationModel(
      {required this.id, this.name, required this.type, required this.createdAt, required this.updatedAt, required final List<
          ParticipantModel> participants, this.lastMessage})
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _ConversationModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.type, type) || other.type == type) &&
            (identical(other.createdAt, createdAt) ||
            ...
            (identical(other.updatedAt, updatedAt) ||
                other.updatedAt == updatedAt) &&
            const DeepCollectionEquality().equals(
                other._participants, _participants) &&
            (identical(other.lastMessage, lastMessage) ||
                other.lastMessage == lastMessage));
  }
...
abstract mixin class _$ConversationModelCopyWith<$Res>
    implements $ConversationModelCopyWith<$Res> {
  factory _$ConversationModelCopyWith(_ConversationModel value,
      $Res Function(_ConversationModel) _then) = __$ConversationModelCopyWithImpl;
