...
mixin _$ReactionEventDto {
 ...
 int get messageId; int get userId; String get userName; String get emoji; String get action;// 'add' or 'remove'
 Map<String, List<int>> get reactions;// Updated reactions map
...
@useResult
$Res call({
 int messageId, int userId, String userName, String emoji, String action, Map<String, List<int>> reactions, String timestamp
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int messageId,  int userId,  String userName,  String emoji,  String action,  Map<String, List<int>> reactions,  String timestamp)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReactionEventDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int messageId,  int userId,  String userName,  String emoji,  String action,  Map<String, List<int>> reactions,  String timestamp)  $default,) {final _that = this;
switch (_that) {
case _ReactionEventDto():
return $default(_that.messageId,_that.userId,_that.userName,_that.emoji,_that.action,_that.reactions,_that.timestamp);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int messageId,  int userId,  String userName,  String emoji,  String action,  Map<String, List<int>> reactions,  String timestamp)?  $default,) {final _that = this;
switch (_that) {
case _ReactionEventDto() when $default != null:
return $default(_that.messageId,_that.userId,_that.userName,_that.emoji,_that.action,_that.reactions,_that.timestamp);case _:
  return null;
