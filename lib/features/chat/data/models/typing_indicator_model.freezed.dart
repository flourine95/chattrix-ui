...
mixin _$TypingIndicatorModel {
  ...
  List<TypingUserModel> get typingUsers;
  ...
  $TypingIndicatorModelCopyWith<TypingIndicatorModel> get copyWith =>
      _$TypingIndicatorModelCopyWithImpl<TypingIndicatorModel>(
          this as TypingIndicatorModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is TypingIndicatorModel &&
...
abstract mixin class $TypingIndicatorModelCopyWith<$Res> {
  factory $TypingIndicatorModelCopyWith(TypingIndicatorModel value,
      $Res Function(TypingIndicatorModel) _then) = _$TypingIndicatorModelCopyWithImpl;

  @useResult
  $Res call({
    String conversationId, List<TypingUserModel> typingUsers
  });
...
extension TypingIndicatorModelPatterns on TypingIndicatorModel {
  ...
  TResult Function( _TypingIndicatorModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
  ...
  @optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String conversationId, List<TypingUserModel> typingUsers)? $default,{required TResult orElse(),}) {final _that = this;
  switch (_that) {
  case _TypingIndicatorModel() when $default != null:
  ...
  @optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String conversationId, List<TypingUserModel> typingUsers) $default,) {final _that = this;
  switch (_that) {
  case _TypingIndicatorModel():
  return $default(_that.conversationId,_that.typingUsers);case _:
  throw StateError('Unexpected subclass');
  ...
  @optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String conversationId, List<TypingUserModel> typingUsers)? $default,) {final _that = this;
  switch (_that) {
  case _TypingIndicatorModel() when $default != null:
  return $default(_that.conversationId,_that.typingUsers);case _:
  return null;
...
class _TypingIndicatorModel extends TypingIndicatorModel {
  const _TypingIndicatorModel(
      {required this.conversationId, required final List<
          TypingUserModel> typingUsers})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TypingIndicatorModelCopyWith<_TypingIndicatorModel> get copyWith =>
      __$TypingIndicatorModelCopyWithImpl<_TypingIndicatorModel>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _TypingIndicatorModel &&
            (identical(other.conversationId, conversationId) ||
                other.conversationId == conversationId) &&
            const DeepCollectionEquality().equals(
...
/// @nodoc
abstract mixin class _$TypingIndicatorModelCopyWith<$Res>
    implements $TypingIndicatorModelCopyWith<$Res> {
  factory _$TypingIndicatorModelCopyWith(_TypingIndicatorModel value,
      $Res Function(_TypingIndicatorModel) _then) = __$TypingIndicatorModelCopyWithImpl;
...
mixin _$TypingUserModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $TypingUserModelCopyWith<TypingUserModel> get copyWith =>
      _$TypingUserModelCopyWithImpl<TypingUserModel>(
          this as TypingUserModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is TypingUserModel &&
...
abstract mixin class $TypingUserModelCopyWith<$Res> {
  factory $TypingUserModelCopyWith(TypingUserModel value,
      $Res Function(TypingUserModel) _then) = _$TypingUserModelCopyWithImpl;
...
extension TypingUserModelPatterns on TypingUserModel {
  ...
  TResult Function( _TypingUserModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _TypingUserModel extends TypingUserModel {
  const _TypingUserModel(
      {required this.id, required this.username, required this.fullName})
      : super._();

  factory _TypingUserModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TypingUserModelCopyWith<_TypingUserModel> get copyWith =>
      __$TypingUserModelCopyWithImpl<_TypingUserModel>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _TypingUserModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.username, username) ||
                other.username == username) &&
            (identical(other.fullName, fullName) ||
...
/// @nodoc
abstract mixin class _$TypingUserModelCopyWith<$Res>
    implements $TypingUserModelCopyWith<$Res> {
  factory _$TypingUserModelCopyWith(_TypingUserModel value,
      $Res Function(_TypingUserModel) _then) = __$TypingUserModelCopyWithImpl;
