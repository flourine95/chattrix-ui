...
mixin _$TypingIndicatorModel {
 ...
 int get conversationId; List<TypingUserModel> get typingUsers;
...
@useResult
$Res call({
 int conversationId, List<TypingUserModel> typingUsers
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int conversationId,  List<TypingUserModel> typingUsers)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TypingIndicatorModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int conversationId,  List<TypingUserModel> typingUsers)  $default,) {final _that = this;
switch (_that) {
case _TypingIndicatorModel():
return $default(_that.conversationId,_that.typingUsers);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int conversationId,  List<TypingUserModel> typingUsers)?  $default,) {final _that = this;
switch (_that) {
case _TypingIndicatorModel() when $default != null:
return $default(_that.conversationId,_that.typingUsers);case _:
  return null;
...
class _TypingIndicatorModel extends TypingIndicatorModel {
  const _TypingIndicatorModel({required this.conversationId, required final  List<TypingUserModel> typingUsers}): _typingUsers = typingUsers,super._();
...
@JsonKey(name: 'userId') int get id; String get username; String get fullName;
...
@useResult
$Res call({
@JsonKey(name: 'userId') int id, String username, String fullName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'userId')  int id,  String username,  String fullName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TypingUserModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'userId')  int id,  String username,  String fullName)  $default,) {final _that = this;
switch (_that) {
case _TypingUserModel():
return $default(_that.id,_that.username,_that.fullName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'userId')  int id,  String username,  String fullName)?  $default,) {final _that = this;
switch (_that) {
case _TypingUserModel() when $default != null:
return $default(_that.id,_that.username,_that.fullName);case _:
  return null;
...
class _TypingUserModel extends TypingUserModel {
  const _TypingUserModel({@JsonKey(name: 'userId') required this.id, required this.username, required this.fullName}): super._();
