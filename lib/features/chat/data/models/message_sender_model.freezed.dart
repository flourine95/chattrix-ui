...
mixin _$MessageSenderModel {
  ...
  $MessageSenderModelCopyWith<MessageSenderModel> get copyWith =>
      _$MessageSenderModelCopyWithImpl<MessageSenderModel>(
          this as MessageSenderModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is MessageSenderModel &&
...
abstract mixin class $MessageSenderModelCopyWith<$Res> {
  factory $MessageSenderModelCopyWith(MessageSenderModel value,
      $Res Function(MessageSenderModel) _then) = _$MessageSenderModelCopyWithImpl;
...
extension MessageSenderModelPatterns on MessageSenderModel {
  ...
  TResult Function( _MessageSenderModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _MessageSenderModel extends MessageSenderModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$MessageSenderModelCopyWith<_MessageSenderModel> get copyWith =>
      __$MessageSenderModelCopyWithImpl<_MessageSenderModel>(this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _MessageSenderModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.username, username) ||
                other.username == username) &&
            (identical(other.fullName, fullName) ||
...
/// @nodoc
abstract mixin class _$MessageSenderModelCopyWith<$Res>
    implements $MessageSenderModelCopyWith<$Res> {
  factory _$MessageSenderModelCopyWith(_MessageSenderModel value,
      $Res Function(_MessageSenderModel) _then) = __$MessageSenderModelCopyWithImpl;
