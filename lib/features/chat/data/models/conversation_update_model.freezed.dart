...
mixin _$ConversationUpdateModel {
  ...
  LastMessageInfoModel? get lastMessage;

  /// Create a copy of ConversationUpdateModel
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ConversationUpdateModelCopyWith<ConversationUpdateModel> get copyWith =>
      _$ConversationUpdateModelCopyWithImpl<ConversationUpdateModel>(
          this as ConversationUpdateModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ConversationUpdateModel &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, conversationId, updatedAt, lastMessage);
...
abstract mixin class $ConversationUpdateModelCopyWith<$Res> {
  factory $ConversationUpdateModelCopyWith(ConversationUpdateModel value,
      $Res Function(ConversationUpdateModel) _then) = _$ConversationUpdateModelCopyWithImpl;
...
class _$ConversationUpdateModelCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? conversationId = null, Object? updatedAt = null, Object? lastMessage = freezed,}) {
...
extension ConversationUpdateModelPatterns on ConversationUpdateModel {
  ...
  TResult Function( _ConversationUpdateModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _ConversationUpdateModel extends ConversationUpdateModel {
  const _ConversationUpdateModel(
      {required this.conversationId, required this.updatedAt, this.lastMessage})
      : super._();

  factory _ConversationUpdateModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ConversationUpdateModelCopyWith<_ConversationUpdateModel> get copyWith =>
      __$ConversationUpdateModelCopyWithImpl<_ConversationUpdateModel>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType &&
        other is _ConversationUpdateModel &&
        (identical(other.conversationId, conversationId) ||
            other.conversationId == conversationId) &&
        (identical(other.updatedAt, updatedAt) ||
            other.updatedAt == updatedAt) &&
...
/// @nodoc
abstract mixin class _$ConversationUpdateModelCopyWith<$Res>
    implements $ConversationUpdateModelCopyWith<$Res> {
  factory _$ConversationUpdateModelCopyWith(_ConversationUpdateModel value,
      $Res Function(_ConversationUpdateModel) _then) = __$ConversationUpdateModelCopyWithImpl;
...
mixin _$LastMessageInfoModel {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $LastMessageInfoModelCopyWith<LastMessageInfoModel> get copyWith =>
      _$LastMessageInfoModelCopyWithImpl<LastMessageInfoModel>(
          this as LastMessageInfoModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is LastMessageInfoModel &&
...
abstract mixin class $LastMessageInfoModelCopyWith<$Res> {
  factory $LastMessageInfoModelCopyWith(LastMessageInfoModel value,
      $Res Function(LastMessageInfoModel) _then) = _$LastMessageInfoModelCopyWithImpl;
...
class _$LastMessageInfoModelCopyWithImpl<$Res>
  ...
  @override
  $Res call(
      {Object? id = null, Object? content = null, Object? senderId = null, Object? senderUsername = null, Object? sentAt = null, Object? type = null,}) {
    return _then(_self.copyWith(
...
extension LastMessageInfoModelPatterns on LastMessageInfoModel {
  ...
  TResult Function( _LastMessageInfoModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _LastMessageInfoModel extends LastMessageInfoModel {
  const _LastMessageInfoModel(
      {required this.id, required this.content, required this.senderId, required this.senderUsername, required this.sentAt, required this.type})
      : super._();

  factory _LastMessageInfoModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$LastMessageInfoModelCopyWith<_LastMessageInfoModel> get copyWith =>
      __$LastMessageInfoModelCopyWithImpl<_LastMessageInfoModel>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _LastMessageInfoModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.content, content) || other.content == content) &&
            (identical(other.senderId, senderId) ||
                other.senderId == senderId) &&
...
/// @nodoc
abstract mixin class _$LastMessageInfoModelCopyWith<$Res>
    implements $LastMessageInfoModelCopyWith<$Res> {
  factory _$LastMessageInfoModelCopyWith(_LastMessageInfoModel value,
      $Res Function(_LastMessageInfoModel) _then) = __$LastMessageInfoModelCopyWithImpl;
