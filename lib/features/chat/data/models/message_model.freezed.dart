...
// Pinned message fields
 bool get pinned; String? get pinnedAt; int? get pinnedBy; String? get pinnedByUsername; String? get pinnedByFullName;// Poll data (for POLL type messages)
 PollDto? get pollData;// Event data (for EVENT type messages)
 EventDto? get eventData;// Metadata for additional message data (e.g., link preview info)
...
as String?,pinnedBy: freezed == pinnedBy ? _self.pinnedBy : pinnedBy // ignore: cast_nullable_to_non_nullable
...
as PollDto?,eventData: freezed == eventData ? _self.eventData : eventData // ignore: cast_nullable_to_non_nullable
as EventDto?,metadata: freezed == metadata ? _self.metadata : metadata // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$EventDtoCopyWith<$Res>? get eventData {
    if (_self.eventData == null) {
    return null;
  }

  return $EventDtoCopyWith<$Res>(_self.eventData!, (value) {
...
class _MessageModel extends MessageModel with DiagnosticableTreeMixin {
  const _MessageModel({required this.id, required this.conversationId, required this.senderId, this.senderUsername, this.senderFullName, required this.content, required this.type, required this.createdAt, this.mediaUrl, this.thumbnailUrl, this.fileName, this.fileSize, this.duration, this.latitude, this.longitude, this.locationName, this.replyToMessageId, this.replyToMessage, final  Map<String, List<int>>? reactions, final  List<int>? mentions, final  List<MentionedUserModel> mentionedUsers = const [], this.sentAt, this.updatedAt, this.edited = false, this.editedAt, this.deleted = false, this.deletedAt, this.forwarded = false, this.originalMessageId, this.forwardCount = 0, this.readCount = 0, final  List<ReadReceiptModel> readBy = const [], this.scheduled = false, this.scheduledTime, this.scheduledStatus, this.pinned = false, this.pinnedAt, this.pinnedBy, this.pinnedByUsername, this.pinnedByFullName, this.pollData, this.eventData, final  Map<String, dynamic>? metadata}): _reactions = reactions,_mentions = mentions,_mentionedUsers = mentionedUsers,_readBy = readBy,_metadata = metadata,super._();
...
@override final  String? pinnedAt;
...
@override final  EventDto? eventData;
...
@override $ReplyToMessageModelCopyWith<$Res>? get replyToMessage;@override $PollDtoCopyWith<$Res>? get pollData;@override $EventDtoCopyWith<$Res>? get eventData;
...
as String?,pollData: freezed == pollData ? _self.pollData : pollData // ignore: cast_nullable_to_non_nullable
as PollDto?,eventData: freezed == eventData ? _self.eventData : eventData // ignore: cast_nullable_to_non_nullable
as EventDto?,metadata: freezed == metadata ? _self._metadata : metadata // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,
  ));
}
