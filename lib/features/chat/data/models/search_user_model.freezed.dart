...
mixin _$SearchUserModel {
  ...
  @JsonKey(name: 'online') bool get isOnline;
  ...
  $SearchUserModelCopyWith<SearchUserModel> get copyWith =>
      _$SearchUserModelCopyWithImpl<SearchUserModel>(
          this as SearchUserModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SearchUserModel &&
...
abstract mixin class $SearchUserModelCopyWith<$Res> {
  factory $SearchUserModelCopyWith(SearchUserModel value,
      $Res Function(SearchUserModel) _then) = _$SearchUserModelCopyWithImpl;

  @useResult
  $Res call({
    int id, String username, String email, String fullName, String? avatarUrl, @JsonKey(
        name: 'online') bool isOnline, String lastSeen, bool contact, bool hasConversation, int? conversationId
  });
...
extension SearchUserModelPatterns on SearchUserModel {
  ...
  TResult Function( _SearchUserModel value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
...
class _SearchUserModel extends SearchUserModel {
  const _SearchUserModel(
      {required this.id, required this.username, required this.email, required this.fullName, this.avatarUrl, @JsonKey(
          name: 'online') required this.isOnline, required this.lastSeen, required this.contact, required this.hasConversation, this.conversationId})
      : super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _SearchUserModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.username, username) ||
                other.username == username) &&
            (identical(other.email, email) || other.email == email) &&
...
/// @nodoc
abstract mixin class _$SearchUserModelCopyWith<$Res>
    implements $SearchUserModelCopyWith<$Res> {
  factory _$SearchUserModelCopyWith(_SearchUserModel value,
      $Res Function(_SearchUserModel) _then) = __$SearchUserModelCopyWithImpl;
